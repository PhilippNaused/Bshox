...
#pragma warning restore CA1810 // Initialize reference type static fields inline
    ...
    public static CSharpCompilation GetCompilation([StringSyntax("C#")] string sourceCode, CSharpCompilationOptions? options = null, CSharpParseOptions? options2 = null)
    {
        ...
        var polyfillTree = CSharpSyntaxTree.ParseText(PolyfillCode, options2, cancellationToken: TestContext.Current?.Execution.CancellationToken ?? CancellationToken.None);
    ...
    public static List<string> GetGeneratedOutput([StringSyntax("C#")] string sourceCode, out ImmutableArray<Diagnostic> diagnostics, CSharpCompilationOptions? options = null, CSharpParseOptions? options2 = null, IIncrementalGenerator? generator = null)
    {
        ...
        return outputCompilation.SyntaxTrees.Where(tree => !string.IsNullOrEmpty(tree.FilePath)).Select(tree => tree.ToString()).ToList();
    }
    ...
    internal static async Task RunTest([StringSyntax("C#")] string sourceCode, ProcessAsync process)
    {
