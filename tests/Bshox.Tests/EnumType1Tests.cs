...
public class EnumType1Tests
{
    ...
    public async Task TestType()
    {
        ...
        await EnumSerializer1.EnumType1.TestSerialization(value, "090200");
        ...
        await EnumSerializer1.EnumType1.TestSerialization(value, "11FFFFFFFFFFFFFFFFFF0100");
    }
    ...
    {
        await EnumSerializer1.ListTestEnum1.TestSerialization([TestEnum1.Value1, TestEnum1.Value2, TestEnum1.Value3], "19010203");
    }
}
