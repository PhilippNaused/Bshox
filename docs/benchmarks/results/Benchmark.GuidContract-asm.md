...
;         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       jne       short M00_L01
       lea       rdx,[rsp+20]
       call      qword ptr [7FFC545CB0B8]; Bshox.DefaultContracts+GuidContract.Serialize(Bshox.BshoxWriter ByRef, System.Guid ByRef)
M00_L00:
       mov       rdi,[rsi+8]
       lea       rsi,[rdi+18]
       add       rdi,8
...
M01_L00:
       ...
       lea       rdx,[rsp+40]
       call      qword ptr [7FFC545C6910]; Bshox.TestUtils.FixedBufferWriter.GetMemory(Int32)
       xor       edi,edi
       xor       ebp,ebp
       mov       rcx,[rsp+40]
       test      rcx,rcx
...
M02_L00:
       ...
       cmp       eax,2A
       jb        short M02_L01
       vmovups   ymm0,[7FFC543DC740]
       vmovups   [rdx],ymm0
       vmovups   ymm0,[7FFC543DC760]
       vmovups   [rdx+20],ymm0
       vmovups   xmm0,[7FFC543DC780]
       vmovups   [rdx+40],xmm0
...
M00_L02:
       ...
       lea       r8,[rsp+38]
       lea       rdx,[rsp+48]
       call      qword ptr [7FFC545BABC0]; Bshox.DefaultContracts+GuidContract.Deserialize(Bshox.BshoxReader ByRef, System.Guid ByRef)
M00_L03:
       vmovups   xmm0,[rsp+38]
       vmovups   [rsi],xmm0
       mov       rax,rsi
...
M01_L14:
       mov       rcx,rsi
       mov       edx,10
       call      qword ptr [7FFC54734450]
       jmp       near ptr M01_L01
M01_L15:
       call      qword ptr [7FFC54734348]
       mov       rcx,rax
       call      CORINFO_HELP_THROW
       int       3
M01_L16:
